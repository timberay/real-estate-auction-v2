...
| **F02. 물건분석 (5탭+최종등급)** | PDF 업로드 → AI(LLM) 자동 분석(권리분석·물건분석 약 30~35개 항목) + 수동 입력. 89개 점검항목을 5개 탭(권리분석 27, 물건분석 13, 현장확인 13, 수익분석 29, 입찰&낙찰 7)으로 분류. 최종등급 탭에서 종합 안전등급 산출. | 진행중 |
