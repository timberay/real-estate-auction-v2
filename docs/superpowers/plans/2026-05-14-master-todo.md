...
| T4.8 | Backlog P3 묶음 (한국어화 / disclaimer / menu Esc / tooltip / heading / nested cards / base_right_date 컨트롤러 테스트) — 묶음 1 ✅ #163 (#3, #6, #14), 묶음 2/3 대기 (#5, #7, #8, #11, #12) | Follow-up #3, #5, #6, #7, #8, #11, #12, #14 |
