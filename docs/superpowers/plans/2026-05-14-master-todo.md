...
| T2.2 | AI 재분석 silent overwrite 방지 (`user_edited` 보존 — name 매칭 overlay + restamp) | ✅ 완료 (#145) — W1-2 / Follow-up #13 |
...
| ID | 항목 | 원본 ref |
|----|------|---------|
| T3.1 | property_type 분기 (주거/업무/상가/토지) | ✅ 완료 (#156) — W2-4 / C27 / E-31 |
| T3.2 | 공유지분 매물 보증금 비율 적용 | ✅ 완료 (#155) — W2-5 / C28 / E-32 |
| T3.3 | 인도명령 6개월 D-day 추적 | ✅ 완료 (#154) — W2-6 / C29 / E-33 |
| T3.4 | Notification 채널 (이메일 + in-app) | ✅ 완료 (#153) — W2-7 / C30 / E-34 |
| T3.5 | B9 비교 보드 확장 (CSV / 예상차익 / sortable / sessionStorage 영속 시스템 테스트) | ✅ 완료 (#152) — Follow-up #20, #21, #22, #23 |
| T3.6 | B11 50건 sync 25s → background job | ✅ 완료 (#151) — Follow-up #24 |
...
| ID | 항목 | 원본 ref |
|----|------|---------|
| T4.1 | 모바일 정렬 묶음 — 한 PR (C1 은 PR #118 에서 처리됨, 잔여 5건 묶음) | ✅ 완료 (#157) — W3-1: C1, C2, C3, C7, C13, C17 |
| T4.2 | 내부 코드 노출 제거 묶음 3건 — 한 PR | ✅ 완료 (#158) — W3-2: C4, C5, C20 |
...
| T4.8 | Backlog P3 묶음 (한국어화 / disclaimer / menu Esc / tooltip / heading / nested cards / base_right_date 컨트롤러 테스트) — 묶음 1 ✅ #163 (#3, #6, #14), 묶음 2 ✅ #164 (#5, #8), 묶음 3 대기 (#7, #11, #12) | Follow-up #3, #5, #6, #7, #8, #11, #12, #14 |
